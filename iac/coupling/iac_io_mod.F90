...
!
! !DESCRIPTION:
! Generic interfaces to netcdf files for IAC
! It seems like most components have one of these, but it's probably
! overkill for our purposes.  Nevertheless, I just copied from RTM in order not to
...
! !USES:
  ...
  use gcam_var_mod   , only : iulog, inst_name, spval
