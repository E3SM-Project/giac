...
contains
  subroutine iac_init(EClock)
    ...
    if (masterproc) then
       ...
       write(iulog, '(A,F6.3)') "crop_setherbfracrem = ",crop_setherbfracrem
       write(iulog, '(A,F6.3)') "crop_setavailtreefracrem = ",crop_setavailtreefracrem
       write(iulog, '(A,I0)') "pasture_addtreeonly = ",pasture_addtreeonly
       write(iulog, '(A,F6.3)') "pasture_setherbfracrem = ",pasture_setherbfracrem
       write(iulog, '(A,F6.3)') "pasture_setavailtreefracrem = ",pasture_setavailtreefracrem
